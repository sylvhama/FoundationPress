...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	...
	//We prefer making one vendors.js file via Grunt
	wp_enqueue_script( 'vendors', get_template_directory_uri() . '/assets/javascript/vendor/vendors.js', array('jquery'), '', true );
	...
	//Scripts only used on article page
	if( is_singular('post') ) {
